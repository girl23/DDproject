...
import '../table/data_model/table_model.dart';
import '../table/xml_table/xml_util.dart';
...
class Utils{
  ...
  static List<TableModel> readXml() {
    List<TableModel> _tableModels = [];
    XmlParseUtil().parseXmlFile("assets/xml/xml4.xml").then((data){
      data.forEach((model){
