...
import '../sheetwidget/sheet_widget.dart';
import '../sheetwidget/sheet_widget_item.dart';
...
class _LySignItemHeaderState extends State<LySignItemHeader> {
  ...
  void initState() {
    ...
    super.initState();
    _isNaCheck = Provider.of<JcSignModel>(context,listen: false).normalSignChoose.contains(widget.itemData["itemId"]);
    _isNormalCheck = Provider.of<JcSignModel>(context,listen: false).naSignChoose.contains(widget.itemData["itemId"]);
  }
              ...
              MaterialButton(
                onPressed: (){
                  ...
                  setState(() {
                    ...
                    Provider.of<JcSignModel>(context,listen: false).naSignChooseChange(widget.itemData["itemId"], _isNaCheck);
                  });
                },
              ...
              MaterialButton(
                onPressed: (){
                  ...
                  setState(() {
                    ...
                    Provider.of<JcSignModel>(context,listen: false).normalSignChooseChange(widget.itemData["itemId"], _isNormalCheck);
                  });
                },
