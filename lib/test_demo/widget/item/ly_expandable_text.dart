...
class LyExpandableText extends StatefulWidget {
  const LyExpandableText(
      this.text, {
        Key key,
  ...
  @override
  _LyExpandableTextState createState() => _LyExpandableTextState();
}

class _LyExpandableTextState extends State<LyExpandableText> {
