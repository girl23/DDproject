...
class LyExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const LyExpansionTile({
    Key key,
    this.leading,
    @required this.title,
  ...
  @override
  _LyExpansionTileState createState() => _LyExpansionTileState();
}

class _LyExpansionTileState extends State<LyExpansionTile>
