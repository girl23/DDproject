...
//          DDComponent.tagAndTextHorizon('dd_use_limit', '${Provider.of<DDDetailViewModel>(context).detailModel?.zzflgo =='1'?'O项':''} ${Provider.of<DDDetailViewModel>(context).detailModel?.zzflgoth=='1'?'其它':''}',  textAlignment: 'spaceBetween',bgColor: KColor.zebraColor2),
  ...
  Widget maintenanceWidget(){
      return Column(
        children: <Widget>[
          //排故
          DDComponent.tagAndTextHorizon('dd_shootingPerson', Provider.of<DDDetailViewModel>(context).detailModel?.maintenanceby,textAlignment: 'spaceBetween',bgColor: KColor.zebraColor2),
          DDComponent.tagAndTextHorizon('dd_shootingDate', Provider.of<DDDetailViewModel>(context).detailModel?.zzdate3, textAlignment: 'spaceBetween',bgColor: KColor.zebraColor3),

        ],
      );
  }
  //处理结果填写区域
  Widget dealResultArea(){
    return Column(
      children: <Widget>[
        Container(
          padding: EdgeInsets.fromLTRB(15, 10, 15, 10),
  ...
  Widget uiForAudit(){
    ...
    return Column(children: <Widget>[
      ...
      Container(
        ...
        child:Row(
          children: <Widget>[
            Container(child:Text(Translations.of(context).text('dd_auditDate'),style: TextStyle(fontSize: KFont.formTitle)),width: ScreenUtil().setWidth(220)),
            Expanded(child:
      ...
      DDComponent.tagAndButtonHorizon('dd_auditPerson', 'temporary_dd_signButton',textAlignment: 'spaceBetween',bgColor: KColor.zebraColor3),
      SizedBox(height: 10,),
