...
class TransferServiceImpl extends BaseService implements TransferService{
  ...
  Future<NetworkResponse> transfer(String ddID, {String number, String planeNo, String reportDate, String reportPlace, int spaceDay, String spaceHour, String spaceCycle, String describe, String keepMeasure, String name, String jno, String faultNum, String inStallNum, String releaseNum, String chapter1, String chapter2, String chapter3, String faultCategory, String influence, String parkingTime, String workHour, String o, String other, String otherDescribe, String m, String aMC, String runLimit, String keepReason, String evidenceType, String chapterNo1, String chapterNo2, String chapterNo3, String chapterNo4, String chapterNo5
    ...
    params.addAll({Element.FORM_TYPE:'DD'});
...
//    realParams.addAll({Element.JSON_DATA:json});
    NetworkResponse networkResponse = await networkRequest.request<DDPublicModel>(NetworkRequest.networkMethod_POST, NetServicePath. complaintDDRequest,data: json);
