...
//    realParams.addAll({Element.JSON_DATA:json});
    NetworkResponse networkResponse = await networkRequest.request<DDPublicModel>(NetworkRequest.networkMethod_POST, NetServicePath. ddDelayRequest,data: json);
