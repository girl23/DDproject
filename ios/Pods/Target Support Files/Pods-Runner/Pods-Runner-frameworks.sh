...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_fullpdfview/flutter_fullpdfview.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_native_image/flutter_native_image.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/image_pickers/image_pickers.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/wifi_info_plugin/wifi_info_plugin.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/zlmacaddress/zlmacaddress.framework"
fi
